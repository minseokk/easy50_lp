      ...
      <main className="flex min-h-screen w-full max-w-4xl flex-col items-start justify-start p-4">
        ...
        <div className="w-full">
          ...
          <table className="m-auto w-full table-auto border-collapse">
            <tbody>
              <tr>
                <td className="border">안전보건관리체계 업무</td>
                <td className="border">
                  <ul>
                    <li>안전보건경영 방침 수립</li>
              ...
              <tr>
                <td className="border">종사자 의견청취</td>
                <td className="border">
                  <ul>
              ...
              <tr>
                <td className="border">산업재해 대응</td>
                <td className="border">
                  <ul>
              ...
              <tr>
                <td className="border">산업재해 통계</td>
                <td className="border">
                  <ul>
              ...
              <tr>
                <td className="border">안전회의 및 TBM</td>
                <td className="border">
                  <ul>
                    <li>회의 안건 공유</li>
                    <li>회의록 작성</li>
              ...
              <tr>
                <td className="border">데이터 저장소</td>
                <td className="border">
                  <ul>
                    <li>모든 데이터 열람</li>
                    <li>간편 서류화 기능</li>
